...
#figure(
  grid(
    columns: 2,
    image("assets_3/philipon_telecoms.png", width: 100%), image("assets_3/philipon_markups.png", width: 100%),
  ),
)
...
#figure(
  image("assets_3/sectoral_spending.png", height: 80%),
...
#figure(
  box(image("assets_3/sticky_wages.png", height: 80%)),
  caption: "Répartition des changements de salaire non nuls, travailleurs horaires\n Données US, Panel 1996 ",
)
...
#figure(
  image("assets_3/inflation_dashboard.png", height: 60%),
