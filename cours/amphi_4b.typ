...
#image("assets_4b/evolution_practices.png")
...
#figure(
  ...
  caption: [Règle de Taylor améliorée (source: Orphanides et Wieland]
)

=== Résumé opérationnel

Évolution de la conduite de la politique monétaire:  depuis les années 90 et le ciblage de l’inflation, les principales banques centrales sont passées au ciblage de l’inflation
