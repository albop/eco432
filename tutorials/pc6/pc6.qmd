...
1. Commenter brièvements les graphes suivants[^sources]. Quelle explication proposeriez-vous pour les ménages dont la MPC est égale à 50%?
...
- certains agents ne sont pas rationnels: ils suivent des règles de consommations (rule of thumb). C'est particulièrement plausible pour la valeur de 50%.
